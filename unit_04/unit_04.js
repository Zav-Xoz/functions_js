...
const t16 = (array) => array.length % 2 === 0;
...
const t17 = (array) => array.every((item) => {
    // console.log(item)
...
const t19 = (str, arg) => {
    ...
    if (arg === true) return Array.from(str).reverse().join('');
}
...
const t20 = (object, num) => {
    const out = Object.keys(object).find((item) => object[item] === num);
