...
document.querySelector('.b-1').addEventListener('click', function () {
    document.querySelector('.out-1').innerHTML = t1(4, 6);
})
...
document.querySelector('.b-3').addEventListener('click', () => {
    document.querySelector('.out-3').innerHTML = t3(16, 4, 2);
})
// Task 4
...
document.querySelector('.b-4').addEventListener('click', () => {
    document.querySelector('.out-4').innerHTML = t4([22, 33, 44, 55]);
})
...
function t8(arr, year) {
    return arr.every(value => value >= year);
}
...
document.querySelector('.b-9').addEventListener('click', () => {
    document.querySelector('.out-9').innerHTML = t9([1, 2, 3, 4], 42).join(' ')
})
// Task 10
